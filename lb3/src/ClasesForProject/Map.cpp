...
Map::Map():m_width(5), m_height(5){     //Карта будет статичной?
    ...
    logger->updateFileE(0,1,m_arrField[0][1].getObj());
    logger->updateFileE(0,1,m_arrField[0][2].getObj());
    logger->updateFileE(0,1,m_arrField[0][3].getObj());
}
...
Map::Map(int sizeX, int sizeY):m_width(sizeX), m_height(sizeY){
    ...
    logger->updateFileE(2,2,m_arrField[2][2].getObj());
    logger->updateFileE(3,3,m_arrField[3][3].getObj());
    logger->updateFileE(4,4,m_arrField[4][4].getObj());
